                ...
                <div class="row mb-1">
                    <div class="col-7">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <input type="text" style="width: 200%" name="supplier_name" value="{{ $invoice->supplier_name }}" readonly="readonly" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal modal-lg fade" id="editPaymentModal" tabindex="-1" aria-labelledby="editPaymentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/pembelian/hutang/edit-bayar') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-1">
                    <div class="col-7">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <input type="text" name="supplier_name" value="{{ $invoice->supplier_name }}" readonly="readonly" class="form-control" style="width: 200%">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    {
        window.location.href = '{{ url('admin/pembelian/hutang/delete-bayar') }}?id='+selected_row;
    }
