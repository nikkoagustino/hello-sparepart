...
<script>
    ...
    $('input[name=invoice_no]').on('change paste keyup', function(){
        ...
        .done(function(result) {
            ...
            $('input[name=supplier_code]').val(invoice_data.supplier_code +' - '+ invoice_data.supplier_name);
    ...
    $('#payButton').on('click', function(){
        if (!invoice_data) {
            ...
            window.location.href='{{ url('admin/pembelian/pembayaran/invoice') }}/'+invoice_no;
        }
    });
</script>
@endsection