...
return new class extends Migration
{
    ...
    {
        Schema::create('tb_pembelian_invoice_master', function (Blueprint $table) {
        ...
        Schema::create('tb_pembelian_invoice_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_pembelian_invoice_master');
        Schema::dropIfExists('tb_pembelian_invoice_items');
    }
};
